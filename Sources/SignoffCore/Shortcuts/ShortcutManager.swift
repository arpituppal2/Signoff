...
public final class ShortcutManager: ObservableObject {
    ...
    public func defaults() -> [BucketBinding] {
        [
            .init(bucketId: BucketID.standard.rawValue,     digitKey: "1", modifier: "cmdCtrl"),
            .init(bucketId: BucketID.professional.rawValue, digitKey: "2", modifier: "cmdCtrl"),
