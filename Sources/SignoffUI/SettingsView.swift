        ...
        Form {
            ...
            Section {
                RichTextToolbar(formatter: footerFormatter)
                    .padding(.bottom, 2)
                RichTextEditor(document: $afterSignoffDoc, placeholder: "Add names, emails, phone numbers…", formatter: footerFormatter)
                    .frame(minHeight: 80)
                    .overlay(
                        RichTextPlaceholder("Add names, emails, phone numbers…", document: afterSignoffDoc)
                    )
