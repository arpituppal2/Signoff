...
public enum PromptComposer: Sendable {
    ...
    public static func compose(
        ...
        let instructions = makeInstructions(from: template, ageGroup: ageGroup ?? .genZ, voiceProfile: voiceProfile)
    ...
    public static func makeInstructions(from template: PromptTemplate, ageGroup: AgeGroup = .genZ, voiceProfile: VoiceProfileSnapshot? = nil) -> String {
