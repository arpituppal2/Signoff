...
/// digit + modifier back to Settings → Shortcuts. Supports ⌃⌘1–6 and ⌥⌘1–6
...
public struct ShortcutRecorderView: View {
    ...
    public var body: some View {
        ...
        .help(session.isRecording
              ? "Press ⌃⌘ or ⌥⌘ plus a digit 1–6. Esc cancels."
        ...
        .accessibilityHint(session.isRecording
                           ? "Press Control-Command or Option-Command and a digit from 1 to 6"
...
private final class RecorderSession: ObservableObject {
    ...
    private static func digit(from event: NSEvent) -> String? {
        ...
        default:
            ...
            guard chars.count == 1, let ch = chars.first, ("1"..."6").contains(ch) else {
                return nil
            }
            return String(ch)
        }
